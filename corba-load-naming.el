 ...
 (module "::CosNaming"
  ...
  (type "::CosNaming::BindingType"
   (:tk_enum "IDL:omg.org/CosNaming/BindingType:1.0" "BindingType"
    ("nobject" "ncontext")))
  (const "::CosNaming::nobject" "IDL:omg.org/CosNaming/BindingType:1.0"
   :nobject)
  (const "::CosNaming::ncontext" "IDL:omg.org/CosNaming/BindingType:1.0"
   :ncontext)
  ...
  (interface "::CosNaming::NamingContext" nil
   ...
   (const "::CosNaming::NamingContext::missing_node"
    "IDL:omg.org/CosNaming/NamingContext/NotFoundReason:1.0" :missing_node)
   (const "::CosNaming::NamingContext::not_context"
    "IDL:omg.org/CosNaming/NamingContext/NotFoundReason:1.0" :not_context)
   (const "::CosNaming::NamingContext::not_object"
    "IDL:omg.org/CosNaming/NamingContext/NotFoundReason:1.0" :not_object)
   (exception "::CosNaming::NamingContext::NotFound"
    (:tk_except "IDL:omg.org/CosNaming/NamingContext/NotFound:1.0" "NotFound"
     (("why" "IDL:omg.org/CosNaming/NamingContext/NotFoundReason:1.0")
      ("rest_of_name" "IDL:omg.org/CosNaming/Name:1.0"))))
   (exception "::CosNaming::NamingContext::CannotProceed"
    (:tk_except "IDL:omg.org/CosNaming/NamingContext/CannotProceed:1.0"
     "CannotProceed"
     (("cxt" "IDL:omg.org/CosNaming/NamingContext:1.0")
      ("rest_of_name" "IDL:omg.org/CosNaming/Name:1.0"))))
